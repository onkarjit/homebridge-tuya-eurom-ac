...
import { TuyaEuromACAccessory } from './platformAccessory';
 ...
 */
export class TuyaEuromACPlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    if (existingAccessory) {
      ...
      new TuyaEuromACAccessory(this, existingAccessory, deviceConfig);
    } else {
      ...
      new TuyaEuromACAccessory(this, accessory, deviceConfig);
